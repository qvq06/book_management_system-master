...
<%@ page import = "com.rain.dao.AdminDao,com.rain.bean.BookBean,com.rain.dao.BookDao,com.rain.bean.AdminBean,com.rain.bean.SubscBean,com.rain.dao.SubscDao" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="/books/selectSubscServlet" method="post">
                                <input type="hidden" name="tip" value="1">
                        			<div class="col-lg-7 form-group">
                                        <label class="col-lg-4 control-label" for="query_bname">年份</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="bookName" name="syear" type="text" value="">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" data-target="#addModal">添加征订</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<SubscBean> bookdata = new ArrayList<SubscBean>();
                             bookdata = (ArrayList<SubscBean>)request.getAttribute("data");
                           if(bookdata==null){
                        	   SubscDao bookdao = new SubscDao();
                        	   bookdata = (ArrayList<SubscBean>)bookdao.get_SubscInfo();
                           }
	
  for (SubscBean bean : bookdata){
  %>                 
								<tbody>
								     <td><%= bean.getSyear() %></td>
	                                <td><%= bean.getCN() %></td>
...
<td>
<button type="button" class="btn btn-danger btn-xs" onclick="deletesubsc(<%=bean.getSid()%>)">删除</button>
	</td>                                            
                          	  </tbody>
                       <%} %> 
                        </table>
    ...
    function deletesubsc(sid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/books/deleteSubscServlet?sid="+sid;
    	}
    }
    </script>
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="/books/AddSubscServlet">   <!--保证样式水平不混乱-->   
                                        <!-- 模态框（Modal） -->
