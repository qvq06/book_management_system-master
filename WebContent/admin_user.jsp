...
id="btn_update" onclick="showInfo2(<%= bean.getUserid()%>,<%= bean.getUname()%><%= bean.getEmail() %>
,<%= bean.getPhone() %>,<%= bean.getPassword() %>,<%= bean.getLend() %>,<%= bean.getMax() %>)">修改</button> -->
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getUserid() %>)">删除</button>
	</td>                                            
                          	  </tbody>
                       <%} %> 
                        </table>
    ...
    function showInfo2(userid,uname,email,phone,password,lend,max) {
        document.getElementById("updateuserid").value = userid;
        document.getElementById("updateuname").value = uname;
        document.getElementById("updateemail").value = email;
        document.getElementById("updatephone").value = phone;
        document.getElementById("updatepassword").value = password;
        document.getElementById("updatelend").value = lend;
    ...
    function deletebook(userid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/books/deleteUserServlet?userid="+userid;
    	}
    }
    </script>
									...
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
											...
											<label for="firstname" class="col-sm-3 control-label">姓名</label>
												<div class="col-sm-7">
												 <input type="hidden" id="updateuserid" name="userid">
													<input type="text" class="form-control" id="updateuname" name="uname"  placeholder=""    >
												<label class="control-label" for="updateuname" style="display: none;"></label>
												</div>
										</div>
										<div class="form-group">	
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可借阅天数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatelend" name="lend"  placeholder=""
													>
												<label class="control-label" for="updatelend" style="display: none;"></label>
												</div>
										</div>	
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大借阅数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatemax" name="max"  placeholder=""
													>
												<label class="control-label" for="updatemax" style="display: none;"></label>
												</div>
										</div>	
										</div>
									...
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">姓名</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="uname" id="addBookName" required="required"  placeholder="请输入姓名">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可借阅天数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="lend" id="updatelend" required="required"  placeholder="请输入可借阅天数">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大可借数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="max" id="updatemax" required="required" placeholder="请输入最大可借数">
												<label class="control-label" for="addPress" style="display: none;"></label>	
												</div>
										</div>
