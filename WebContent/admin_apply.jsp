...
<%@ page import = "com.rain.bean.HistoryBean,com.rain.dao.AdminDao,com.rain.dao.BookDao,com.rain.bean.ApplyBean,com.rain.bean.AdminBean" %>
                    ...
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                           ...
                           if(bookdata==null){
                        	   ...
                        	   bookdata = (ArrayList<ApplyBean>)bookdao.get_ApplyInfo(0);
                           }
...
<td><button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateModal" 
  id="btn_update" onclick="agreeApply(<%= bean.getAid() %>)">通过</button>
  <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateModal" 
  id="btn_update" onclick="refuseApply(<%= bean.getAid() %>)">不通过</button>
	</td>                                            
                          	  </tbody>
                       <%} %> 
                        </table>
 ...
 <script type="text/javascript">
    function agreeApply(aid) {
    	con=confirm("是否同意委托借阅?"); 
    	if(con==true){
    		location.href = "/books/AddApplyServlet?tip=1&aid="+aid;
    	}
    }
    </script>
   <script type="text/javascript">
    function refuseApply(aid) {
    	con=confirm("是否不同意委托借阅?"); 
    	if(con==true){
    		location.href = "/books/AddApplyServlet?tip=2&aid="+aid;
    	}
    }
    </script>   
