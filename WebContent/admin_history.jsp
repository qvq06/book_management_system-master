...
<%@ page import = "com.rain.bean.HistoryBean,com.rain.dao.AdminDao,com.rain.dao.BookDao,com.rain.bean.AdminBean" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">期刊归还信息</div>
                            </div>
