        ...
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" method="post" action="/books/LoginServlet">
                 <% 
					...
					if(state!=null){
					%>
                 <label class="control-label" for="userid">密码错误</label>
                 
                 <%}%>
                <div class="form-group">
                    <label class="control-label" for="userid">账&nbsp;号</label>
                    <input type="text" class="form-control" id="userid" name="userid" required="required" placeholder="学号"/>
